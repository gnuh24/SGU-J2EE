...
-- Thêm lại Invoice khớp đúng theo ticket
INSERT INTO `Invoice` (`id`, `totalAmount`, `createdAt`, `paymentMethod`, `paymentStatus`, `profileId`) VALUES
('I001', 150000.00, DATE_SUB(NOW(), INTERVAL 1 DAY), 'CREDIT_CARD', 'PAID', 'P001'),
('I002', 200000.00, DATE_SUB(NOW(), INTERVAL 3 DAY), 'CASH', 'PENDING', 'P002'),
('I003', 180000.00, DATE_SUB(NOW(), INTERVAL 7 DAY), 'BANK_TRANSFER', 'PAID', 'P003'),
('I004', 220000.00, DATE_SUB(NOW(), INTERVAL 2 DAY), 'CREDIT_CARD', 'CANCELLED', 'P004'),
('I005', 175000.00, DATE_SUB(NOW(), INTERVAL 5 DAY), 'CASH', 'PAID', 'P002'),
('I006', 150000.00, DATE_SUB(NOW(), INTERVAL 10 DAY), 'BANK_TRANSFER', 'PAID', 'P002'),
('I007', 200000.00, DATE_SUB(NOW(), INTERVAL 12 DAY), 'BANK_TRANSFER', 'CANCELLED', 'P002'),
('I008', 180000.00, DATE_SUB(NOW(), INTERVAL 8 DAY), 'CREDIT_CARD', 'PENDING', 'P002'),
('I009', 220000.00, DATE_SUB(NOW(), INTERVAL 15 DAY), 'CASH', 'PAID', 'P002'),
('I010', 175000.00, DATE_SUB(NOW(), INTERVAL 20 DAY), 'CREDIT_CARD', 'PAID', 'P002');
